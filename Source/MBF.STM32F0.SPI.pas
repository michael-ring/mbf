...
type
  TSPIMOSIPins = (
    ...
    {$if defined(has_SPI1) and defined(has_gpioa) },   D11_SPI = ALT0 or TNativePin.PA7  {$endif}
  ...
  TSPIMISOPins = (
    ...
    {$if defined(has_SPI1) and defined(has_gpioa) },   D12_SPI = ALT0 or TNativePin.PA6  {$endif}
  ...
  TSPISCLKPins = (
    ...
    {$if defined(has_SPI1) and defined(has_gpioa) },   D13_SPI = ALT0 or TNativePin.PA5  {$endif}
  ...
  TSPINSSPins = (
    {$if defined(has_SPI1) and defined(has_gpioa) }   D10_SPI  =         TNativePin.PB6  {$endif}
...
begin
    case longWord(@Self) of
    {$ifdef has_spi1}SPI1_BASE : BaseFrequency := SystemCore.GetAPB1PeripheralClockFrequency;{$endif}
