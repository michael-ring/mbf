...
type
  TSPIMOSIPins = (
    ...
    {$if defined(has_SPI1) and defined(has_gpiod)}, PD7_SPI1 = ALT5 or TNativePin.PD7 {$endif}
    ...
    {$if defined(has_SPI6) and defined(has_gpioa)}, PA7_SPI6 = ALT8 or TNativePin.PA7 {$endif}
    {$if defined(has_SPI6) and defined(has_gpiob)}, PB5_SPI6 = ALT8 or TNativePin.PB5 {$endif}
  );
  TSPIMISOPins = (
    NONE_SPI = TNativePin.None
    ...
    {$if defined(has_SPI1) and defined(has_gpiog)}, PG9_SPI1 = ALT5 or TNativePin.PG9 {$endif}
    ...
    {$if defined(has_SPI6) and defined(has_gpioa)}, PA6_SPI6 = ALT8 or TNativePin.PA6 {$endif}
    {$if defined(has_SPI6) and defined(has_gpiob)}, PB4_SPI6 = ALT8 or TNativePin.PB4 {$endif}
  );
  TSPISCLKPins = (
    NONE_SPI = TNativePin.None
    ...
    {$if defined(has_SPI2) and defined(has_gpioa)}, PA12_SPI2 = ALT5 or TNativePin.PA12 {$endif}
    ...
    {$if defined(has_SPI1) and defined(has_gpiog)}, PG11_SPI1 = ALT5 or TNativePin.PG11 {$endif}
    ...
    {$if defined(has_SPI6) and defined(has_gpioa)}, PA5_SPI6 = ALT8 or TNativePin.PA5 {$endif}
    {$if defined(has_SPI6) and defined(has_gpiob)}, PB3_SPI6 = ALT8 or TNativePin.PB3 {$endif}
  );
  TSPINSSPins = (
    NONE_SPI = TNativePin.None
    {$if defined(has_arduinopins)                 },   D10_SPI = TNativePin.PD14  {$endif}
    ...
    {$if defined(has_SPI1) and defined(has_gpiog)}, PG10_SPI1 = ALT5 or TNativePin.PG10 {$endif}
    ...
    {$if defined(has_SPI6) and defined(has_gpioa)}, PA15_SPI6 = ALT7 or TNativePin.PA15 {$endif}
    {$if defined(has_SPI2) and defined(has_gpiob)}, PB4_SPI2 = ALT7 or TNativePin.PB4 {$endif}
    {$if defined(has_SPI6) and defined(has_gpioa)}, PA4_SPI6 = ALT8 or TNativePin.PA4 {$endif}
  );
...
begin
  ...
  case longWord(@Self) of
    ...
    {$ifdef has_spi4}SPI5_BASE : GPIO.SetPinLevelHigh(NSSPins[5] and $ff);{$endif}
    {$ifdef has_spi4}SPI6_BASE : GPIO.SetPinLevelHigh(NSSPins[6] and $ff);{$endif}
  end;
end;
