...
begin
  ...
  beginTransAction;
  WriteCommand(CMD_PAGE_ADDRESS,Y shr 3,(Y+Height-1) shr 3);
...
var
  ...
  offset,bit,divFactor,pixel,pixels : byte;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              FontInfo.pRowBuffer^[7-bit+x1 shl 3] := 0;
              ...
              begin
                ...
                {$endif}
                FontInfo.pRowBuffer^[7-bit+(x1 shl 3)] := FontInfo.pRowBuffer^[7-bit+(x1 shl 3)] or (1 shl offset);
              end;
              if BackgroundColor = clWhite then
                FontInfo.pRowBuffer^[7-bit+(x1 shl 3)] := not FontInfo.pRowBuffer^[7-bit+(x1 shl 3)];
            end;
          end;
