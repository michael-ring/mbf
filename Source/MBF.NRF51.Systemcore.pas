...
{< Nordic Semiconductor NRF51 board series functions. }
interface
...
{$if defined(nrf51) }
// All Nordic chips have 16MHz
const
  MaxCPUFrequency=16000000;
{$else}
  {$error Unknown Chip, please check mbf.boards.nrf51.inc and then define maximum CPU Frequency here}
{$endif}
...
type
  ...
  TNRF51SystemCore = record helper for TSystemCore
  type
...
procedure TNRF51SystemCore.Initialize;
begin
  FTimerNormalize := 1;
  ConfigureSystem;
  ConfigureTimer;
...
function TNRF51SystemCore.GetSysTickClockFrequency : Cardinal; [public, alias: 'MBF_GetSysTickClockFrequency'];
begin
  Result := GetHCLKFrequency;
end;

function TNRF51SystemCore.GetAPB1PeripheralClockFrequency : Cardinal;
var
  divider : byte;
begin
...
function TNRF51SystemCore.GetAPB1TimerClockFrequency : Cardinal;
begin
...
function TNRF51SystemCore.GetAPB2PeripheralClockFrequency : Cardinal;
var
  Divider : byte;
begin
...
function TNRF51SystemCore.GetAPB2TimerClockFrequency : Cardinal;
begin
...
procedure TNRF51SystemCore.ConfigureSystem;
var
  temp : longWord;
begin
...
function TNRF51SystemCore.getFrequencyParameters(aHCLKFrequency : longWord;aClockType : TClockType):TOSCParameters;
var
  PREDIV : byte;
  PLLMUL : byte;
  AHBPRE : byte;
...
function TNRF51SystemCore.GetHCLKFrequency : longWord;
var
  temp : longWord;
begin
...
function TNRF51SystemCore.GetSYSCLKFrequency : longWord;
var
  temp : longWord;
begin
...
procedure TNRF51SystemCore.SetCPUFrequency(const Value: Cardinal; aClockType : TClockType = TClockType.PLLHSI);
var
  dummy : longWord;
...
function TNRF51SystemCore.GetCPUFrequency : longWord;
begin
  Result := GetHCLKFrequency;
end;
