...
type
  TI2CSDAPins = (
                             PB7_I2C1=ALT4 or TNativePin.PB7
                           , PB9_I2C1=ALT4 or TNativePin.PB9
  {$if defined(has_arduinopins)}
                           , D15_I2C =ALT4 or TNativePin.PB9
  {$endif}
                           ,PB11_I2C2=ALT4 or TNativePin.PB11
                           , PC9_I2C3=ALT4 or TNativePin.PC9
  {$if defined (has_gpioh)}, PF0_I2C2=ALT4 or TNativePin.PF0{$endif}
  {$if defined (has_gpioh)}, PH5_I2C2=ALT4 or TNativePin.PH5{$endif}
  {$if defined (has_gpioh)}, PH8_I2C3=ALT4 or TNativePin.PH8{$endif}
  );

  TI2CSCLPins = (
                             PA8_I2C3=ALT4 or TNativePin.PA8
                           , PB6_I2C1=ALT4 or TNativePin.PB6
                           , PB8_I2C1=ALT4 or TNativePin.PB8
  {$if defined(has_arduinopins)}
                           , D14_I2C =ALT4 or TNativePin.PB8
  {$endif}
                           ,PB10_I2C2=ALT4 or TNativePin.PB10
  {$if defined (has_gpiof)}, PF1_I2C2=ALT4 or TNativePin.PF1{$endif}
  {$if defined (has_gpioh)}, PH4_I2C2=ALT4 or TNativePin.PH4{$endif}
  {$if defined (has_gpioh)}, PH7_I2C3=ALT4 or TNativePin.PH7{$endif}
  );
...
begin
  case longWord(@Self) of
    I2C1_BASE:  RCC.APB1ENR := RCC.APB1ENR or (1 shl 21);
    I2C2_BASE:  RCC.APB1ENR := RCC.APB1ENR or (1 shl 21);
    I2C3_BASE:  RCC.APB1ENR := RCC.APB1ENR or (1 shl 21);
  end;
