...
const
{$if defined(ARDUINOUNO) or defined(ARDUINONANO) or defined(MEGA328PXPLAINEDMINI)}
  MaxCPUFrequency = 16000000;
{$elseif defined(atmega4809curiositynano)}
...
procedure SysTick_interrupt; interrupt; [public, alias: 'TIMER0_COMPA_ISR'];
begin
TCNT0 := 0; // Freshly start counting for next round
Inc(SysTickCounter);
end;
...
begin
  ...
  //Dividing by 1024 brings a little error of 2.5% BUT it saves 2-3k image size in cases where no other code uses math code of RTL
